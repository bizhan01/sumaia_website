     							...
     							<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
									 <div class="row form-group">
										 <div class="col-md-6">
											 ...
											 <input type="text" name="name" value = '<?php echo $bio[0]->name; ?>'  class="form-control"  placeholder="اسم کامل" required>
										 </div>
										 <div class="col-md-6">
											 <label  style="color: black">شعار</label>
											 <input type="text" name="motto" value = '<?php echo $bio[0]->motto; ?>'  class="form-control"  placeholder="شعار" required>
										 </div>
									 </div>
									 <div class="row form-group">
										 <div class="col-md-6">
											 <label  style="color: black">بیوگرافی</label><br>
											 <textarea name="biography" rows="10" class="col-md-12" placeholder="لطفا بیوگرافی تان را در حداکثر 300 کلمه بنویسید"><?php echo $bio[0]->biography; ?></textarea>
										 </div>
										 <div class="col-md-6">
											 <label  style="color: black">تصویر</label>
											 <input type="hidden" name="image" value="<?php echo $bio[0]->image; ?>">
											 <input type="file" name="image" id="input-file-now-custom-1" class="dropify" data-default-file="/UploadedImages/<?php echo $bio[0]->image; ?>" />
										 </div>
									 </div>
									 <div class="row form-group">
										 <div class="col-md-6">
